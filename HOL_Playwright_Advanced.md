...
- [🌐 Sprachauswahl – TypeScript/JavaScript oder C# (.NET)](#-sprachauswahl--typescriptjavascript-oder-c-net)
- [Lernziele](#lernziele)
- [Voraussetzungen](#voraussetzungen)
- [Glossar: Playwright-Begriffe auf einen Blick](#glossar-playwright-begriffe-auf-einen-blick)
- [Teil 0: IDE-Setup](#teil-0-ide-setup)
  - [Visual Studio Code (TypeScript & C#)](#visual-studio-code-typescript--c)
  - [Visual Studio 2022 / 2026 (C# / .NET)](#visual-studio-2022--2026-c--net)
- [Teil 0B: Projekt-Setup](#teil-0b-projekt-setup)
  - [Schritt 1: App-Repo klonen und starten](#schritt-1-für-alle-app-repo-klonen-und-starten)
  - [Schritt 2: Playwright-Testprojekt einrichten](#schritt-2-playwright-testprojekt-einrichten)
  - [Setup: C# / .NET – Testframework wählen](#setup-c--net--testframework-wählen)
- [Teil 0C: App-Konfiguration](#teil-0c-app-konfiguration--was-du-über-die-todomatic-app-wissen-musst)
  - [Starten der App](#starten-der-app)
  - [Initialer App-Zustand: 1 vorhandene Aufgabe](#initialer-app-zustand-1-vorhandene-aufgabe)
  - [Statische Dateien](#statische-dateien)
  - [Geolocation ist Pflicht beim Hinzufügen von Aufgaben](#geolocation-ist-pflicht-beim-hinzufügen-von-aufgaben)
  - [Keine Persistenz](#keine-persistenz)
- [Übersicht der App-Struktur (TodoMatic)](#übersicht-der-app-struktur-todomatic)
- [Teil 1: Code-Driven vs. Codegen – Zwei Wege zum Test](#teil-1-code-driven-vs-codegen--zwei-wege-zum-test)
  - [💻 Ansatz 1: Code-Driven (vom Trainer empfohlen)](#-ansatz-1-code-driven-vom-trainer-empfohlen)
  - [🎬 Ansatz 2: Codegen (Recorder)](#-ansatz-2-codegen-recorder)
  - [🔄 Empfohlener Workflow: das Beste aus beiden Welten](#-empfohlener-workflow-das-beste-aus-beiden-welten)
- [Exercise 1: Smoke Test – Seiteninhalt prüfen](#exercise-1-smoke-test--seiteninhalt-prüfen)
- [Exercise 2: Geolocation mocken und Aufgabe hinzufügen](#exercise-2-geolocation-mocken-und-aufgabe-hinzufügen)
- [Exercise 3: Aufgabe bearbeiten, löschen und Zähler prüfen](#exercise-3-aufgabe-bearbeiten-löschen-und-zähler-prüfen)
- [Exercise 4: Filter-Funktionalität testen](#exercise-4-filter-funktionalität-testen)
- [Teil 2: Debugging-Tools](#teil-2-debugging-tools)
  - [🔍 Tool 1: Playwright Inspector (PWDEBUG)](#-tool-1-playwright-inspector-pwdebug)
  - [📊 Tool 2: Playwright Trace Viewer](#-tool-2-playwright-trace-viewer)
  - [🌐 Tool 3: Browser DevTools](#-tool-3-browser-devtools)
  - [🖥️ Tool 4: Playwright UI Mode](#️-tool-4-playwright-ui-mode)
- [Exercise 5: Netzwerk-Mocking – Remote-Tasks abfangen](#exercise-5-netzwerk-mocking--remote-tasks-abfangen)
- [Exercise 6: Response-Manipulation – Logo durch Testbild ersetzen](#exercise-6-response-manipulation--logo-durch-testbild-ersetzen)
- [Exercise 7: Screenshots, Video und Traces – Diagnose-Werkzeuge aktiv nutzen](#exercise-7-screenshots-video-und-traces--diagnose-werkzeuge-aktiv-nutzen)
  - [Teil A: Screenshots](#teil-a-screenshots)
  - [Teil B: Video-Aufnahme](#teil-b-video-aufnahme)
  - [Teil C: Trace Viewer – vollständiger Zeitstrahl](#teil-c-trace-viewer--vollständiger-zeitstrahl)
  - [Teil D: Visual Regression – `toHaveScreenshot()` (Bonus)](#teil-d-visual-regression--tohavescreenshot-bonus)
- [Exercise 8: Mobile Device Emulation](#exercise-8-mobile-device-emulation)
- [Exercise 9: Cross-Browser Testing](#exercise-9-cross-browser-testing)
- [Exercise 10: JavaScript in die Seite injizieren mit `page.evaluate()`](#exercise-10-javascript-in-die-seite-injizieren-mit-pageevaluate)
- [Exercise 11: Page Object Model – Wartbarkeit und Wiederverwendung](#exercise-11-page-object-model--wartbarkeit-und-wiederverwendung)
- [Exercise 12: CI/CD – GitHub Actions, Azure Pipelines und Docker](#exercise-12-cicd--github-actions-azure-pipelines-und-docker)
  - [Variante A: GitHub Actions](#variante-a-github-actions)
  - [Variante B: Azure Pipelines](#variante-b-azure-pipelines)
  - [Variante C: Docker-Container](#variante-c-docker-container)
- [Exercise 13 (Bonus): Azure Playwright Testing Service](#exercise-13-bonus-azure-playwright-testing-service)
- [Exercise 14 (Bonus): Playwright MCP Server – KI-gesteuerte Browser-Automatisierung](#exercise-14-bonus-playwright-mcp-server--ki-gesteuerte-browser-automatisierung)
- [Exercise 15 (Bonus): Playwright CLI – Token-effiziente Browser-Automatisierung](#exercise-15-bonus-playwright-cli--token-effiziente-browser-automatisierung)
- [Zusammenfassung: Gelerntes auf einen Blick](#zusammenfassung-gelerntes-auf-einen-blick)
- [Trouble-shooting – Häufige Fehler und Lösungen](#trouble-shooting--häufige-fehler-und-lösungen)
